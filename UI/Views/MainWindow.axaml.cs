...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        AcceptButton.Click += (s, e) => 
        {
            try
            {
                ViewModel.Lambda = double.Parse((string)ValueLambdaInput.Text) * Giga;
                ViewModel.Mu = double.Parse((string)ValueMuInput.Text) * Giga;
                ViewModel.V = double.Parse((string)ValueVInput.Text) * Giga;
                ViewModel.Ro = double.Parse((string)ValueRoInput.Text);
                ...
                var currentTask = Enumerable.FirstOrDefault<TaskInfo>(MyCustomList.ItemsSource, x => x.Id == ViewModel.TaskId);
